...
const v5ClanRules = <ClanDef>[
  ...
  ClanDef(
    'Caitiff',
    [],
    'Nessuna Debolezza di clan: i Caitiff non discendono '
  ...
  ClanDef(
    'Ravnos',
    ['Animalità', 'Oscurazione', 'Ascendente'],
    'Fuoco nel '
  ...
  ClanDef(
    'Sangue Debole',
    [],
    'Nessuna Debolezza di clan, a meno di prendere '
  ...
  ClanDef(
    'Ventrue',
    ['Dominazione', 'Robustezza', 'Ascendente'],
    'Gusti '
...
const v20ClanRules = <ClanDef>[
  ...
  ClanDef(
    'Caitiff',
    [],
    'Senza clan: nessuna Disciplina di clan e nessuna '
