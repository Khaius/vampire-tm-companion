...
const darkAgesSchema = SheetSchema(
  ...
  attributes: [
    ...
    TraitGroup('mentali', 'Mentali', [
      TraitDef('attr.percezione', 'Percezione',
  ...
  abilities: [
    ...
    TraitGroup(
      ...
      'Capacità',
      [
        TraitDef('ab.affinitaanimale', 'Affinità Animale',
            specialtyKey: 'spec.ab.affinitaanimale'),
        TraitDef('ab.armidamischia', 'Armi da Mischia',
            specialtyKey: 'spec.ab.armidamischia'),
        TraitDef('ab.cavalcare', 'Cavalcare',
            specialtyKey: 'spec.ab.cavalcare'),
        TraitDef('ab.commercio', 'Commercio',
            specialtyKey: 'spec.ab.commercio'),
        TraitDef('ab.espressioneartistica', 'Espressione Artistica',
            specialtyKey: 'spec.ab.espressioneartistica'),
        TraitDef('ab.furtivita', 'Furtività',
            specialtyKey: 'spec.ab.furtivita'),
        TraitDef('ab.galateo', 'Galateo', specialtyKey: 'spec.ab.galateo'),
        TraitDef('ab.manualita', 'Manualità',
            specialtyKey: 'spec.ab.manualita'),
        TraitDef('ab.sopravvivenza', 'Sopravvivenza',
            specialtyKey: 'spec.ab.sopravvivenza'),
        TraitDef('ab.tiroconlarco', 'Tiro con l\'Arco',
    ...
    TraitGroup(
      ...
      [
        ...
        TraitDef('ab.saggezzapopolare', 'Saggezza Popolare',
  ...
  lists: [
    ...
    ListSection(
      ...
      slots: 7,
      nameLabel: 'Pregio',
      columns: [ColumnDef('tipo', 'Tipo'), ColumnDef('costo', 'Costo', flex: 1)],
    ),
    ListSection(
      key: 'difetti',
      title: 'Difetti',
      slots: 7,
      nameLabel: 'Difetto',
      columns: [ColumnDef('tipo', 'Tipo'), ColumnDef('bonus', 'Bonus', flex: 1)],
    ),
    ListSection(
      key: 'rituali',
      title: 'Rituali',
    ...
    ListSection(key: 'vie', title: 'Vie', slots: 7, hasDots: true),
    ListSection(
      key: 'armi',
      title: 'Combattimento',
      slots: 6,
  ...
  textSections: [
    ...
    TextSection(
      ...
      'Proprietà',
      fields: [
        FieldDef('pr_trasportato', 'Equipaggiamento (trasportato)',
            multiline: true),
        FieldDef('pr_posseduto', 'Equipaggiamento (posseduto)',
            multiline: true),
